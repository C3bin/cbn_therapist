        ...
        options = {
            [_U('deal_meeting')] = {
                ...
                onSelect = function()
                    ...
                    ESX.TriggerServerCallback("cbn_therapist:hasMoney",
                                              function(hasMoney)
                        ...
                        if hasMoney then
                            SetEntityCoords(PlayerPedId(), -1897.8439,
                                            -572.8386, 11.8461, false, false,
                                            false, true)
                            local doctor =
                                CreatePed(8, GetHashKey("cs_drfriedlander"),
                                          -1898.5520, -572.3199, 11.8426,
                                          226.7172, false, true)
                            lib.progressBar({
                                duration = 5000,
                            ...
                            RegisterEntityForCutscene(PlayerPedId(), 'Michael',
                                                      0, 0, 64)
                            DoScreenFadeIn(2000)
                            StartCutscene(0)
